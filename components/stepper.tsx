...
// Export types separately instead of using namespace
      ...
      Navigation: ({
        ...
        return (
          <nav
            ...
            // biome-ignore lint/a11y/noNoninteractiveElementToInteractiveRole: <dont care>
            role="tablist"
            {...props}
          >
            <ol
        ...
        if (variant === "circle") {
          return (
            <li
              ...
              className={cn(
                "flex items-center gap-4 rounded-md transition-colors shrink-0",
                className,
              )}
            >
              <CircleStepIndicator
          ...
          <>
            ...
            {variant === "vertical" && (
              <div className="flex gap-4">
                ...
                <div className="flex-1 my-3 ps-4">{panel}</div>
              </div>
            )}
          </>
        );
...
const StepperSeparator = ({
  ...
  return (
    <div
      ...
      // biome-ignore lint/a11y/useAriaPropsForRole: <dont care>
      role="separator"
      tabIndex={-1}
